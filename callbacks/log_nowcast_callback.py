"""
Log deterministic nowcast images to the model logger.
...
class LogNowcast(Callback):
    ...
    def on_validation_batch_end(
        ...
        y_hat = outputs["prediction"]
        x, y, idx = batch
        to_dBZ = trainer.datamodule.valid_dataset.scaled_to_dbz
    ...
    def on_test_batch_end(
        ...
        y_hat = outputs["prediction"]
        x, y, idx = batch
        to_dBZ = trainer.datamodule.test_dataset.scaled_to_dbz
        if batch_idx in self.verif_display:
